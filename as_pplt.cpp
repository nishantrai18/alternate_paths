...
int alt_path(int na, int nb, float share, float stretch, float localt, FILE* f, FILE* f2, FILE* f3 );
...
int main()
{
	...
	*/
	...
	FILE* f2=fopen("fin_cb.js","w");
	FILE* f3=fopen("tmpb_cands.js","w");

	f=fopen("fin_pb.js","w");
	alt_path(S,T,share, stretch, localt, f, f2, f3);
...
int alt_path(int na, int nb, float share, float stretch, float localt, FILE* f, FILE* f2, FILE* f3)
{
	...
	*/	
	...
	cout<<"TOTAL FOUND WERE : "<<cnt<<endl;
	altp_dist[cnt]+=1;
