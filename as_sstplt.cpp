...
int main()
{
	...
	*/
	...
	share=0.8,stretch=0.5,localt=0.15;
	threshold=0.05;
	...
	*/
	...
	int S[]={7793,193330,80869,114596,65457,18912,57913};
	int T[]={85798,223316,222569,123213,1912,185203,255434};
	...
	for(i=0;i<7;i++)
	{
		...
		alt_path( S[i], T[i], share, stretch, localt);

		int ti;
		for(ti=1;ti<thesz;ti++)
		{
			cout<<thes[ti]<<" "<<thest[ti]<<endl;
			//cout<<thes[ti]<<" "<<thest[ti+1]<<endl;
		}	
		//cout<<thes[ti]<<" "<<thest[ti]<<endl;		
	}
			...
			for(int tr=0;(!t)&&(tr<partner.size());tr++)
			{
				...
				*/
				...
				if(t==1)
				{
					...
					thes[thesz]=thes[thesz-1];
					if(thes[thesz]>param_share)
